...
public class WebUtilis extends JavaUtilis {
	...
	// Method for waitExplicit only by click
	...
	// Actions class method to move the page down
	...
	// Method to handle the Web elements
	...
	// Method to navigate to backward
